...
class Hand:
    ...
    # We will need how many dice will be rolled afterward
    def all_dice(self):
    ...
    # For testing is important to have a method that allows to directly set the faces to a certain value.
    def set_faces(self, values):
        for idx, val in enumerate(values):
            self.hand[idx].set_face(val)

    # Convenience methods e.g. counting the number of times of a value or sum of values
    def count(self, i):
